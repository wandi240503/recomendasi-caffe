...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('images/logo.png') }}?v=99">
    <link rel="icon" type="image/x-icon" href="{{ asset('favicon.ico') }}?v=99">
    <link rel="shortcut icon" href="{{ asset('images/logo.png') }}?v=99">
    <link rel="apple-touch-icon" href="{{ asset('images/logo.png') }}?v=99">
